            ...
            <div class="modal-dialog modal-">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-4">
                        ...
                        <input readonly class="form-control text-center" type="text" value="Inactive" style="color:red; background:transparent; border-radius:20px;" readonly>
                    </div>
                </div>
                <div class="row g-4 mb-3">
                    <div class="col-6">
               ...
               function updateStatus(id){
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                            url: '/TNAN/admin/php/custActivate.php',
                            type: 'POST',
                            dataType: 'json',
                        ...
                        text: "customer was activate successfully",
                        icon: 'success',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: 'Continue'
                        }).then((result) => {
                        if (result.isConfirmed) {
                            window.location = "/TNAN/admin/customerA.php";
                        }
                        })
                        }
                        })
